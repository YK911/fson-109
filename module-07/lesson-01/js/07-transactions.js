...
const tableBodyMarkup = transactionHistory =>
  transactionHistory.map(rowMarkup).join('');

tableEl.insertAdjacentHTML('beforeend', tableBodyMarkup(transactionHistory));
